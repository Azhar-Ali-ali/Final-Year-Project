...
const cmsDatabase = {
	...
	banners: [
		...
		{
			id: 'BAN002',
			title: 'Men Collection Launch',
			location: 'men',
			headline: 'Men Fashion Collection',
			subtext: 'New arrivals in men fashion',
			ctaText: 'View Collection',
			ctaLink: 'https://mystore.com/men',
			image: 'https://via.placeholder.com/1200x400/232f3e/ffffff?text=Men+Collection',
		...
		{
			id: 'BAN003',
			title: 'Accessories Mega Deal',
			location: 'accessories',
			headline: 'Accessories Mega Deal',
			subtext: 'Best accessories deals of the season',
			ctaText: 'Explore',
			ctaLink: 'https://mystore.com/accessories',
			image: 'https://via.placeholder.com/1200x400/232f3e/ffffff?text=Accessories+Deal',
